    ...
    return (
        <main className="mt-14 mx-8">
             <section className="flex justify-around ">
                {/* left side */}
                <div>
                <Image width={400} height={200} src="/p4.jpg" alt="model" />

                </div>
                {/* right side */}
                <div className="mr-7">
                    <h1 className="font-bold font-sans text-3xl mb-3">Nautica</h1>
                        <p>Men's Sustainably Crafted Classic Fit Deck Polo</p> 
                        <h4 className="mt-5 font-bold">$ 150</h4>
                     <p className="mt-2  font-sans font-light">150+ bought in past month</p>

    ...
    return (
        <main className="mt-14 mx-8">
             <section className="flex justify-around ">
                {/* left side */}
                <div>
                <Image width={300} height={200} src="/p8n.jpg" alt="model" />

                </div>
                {/* right side */}
                <div className="mr-7">
                    <h1 className="font-bold font-sans text-3xl mb-3 text-green-700">Wrangler</h1>
                        <p>Authentics Men's Classic Cargo Stretch Short</p> 
                        <h4 className="mt-5 font-bold">$ 160</h4>
